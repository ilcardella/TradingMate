...
class SettingsWindow(tk.Toplevel):
    ...
    def create_UI(self):
        ttk.Label(self, text="Trading log path:").grid(
            row=0, sticky="w", padx=5, pady=5
        )
        ttk.Label(self, text="Credentials path:").grid(
        ...
        self.e_log_path = ttk.Entry(
            self, width=50, textvariable=self.trading_log_string
        )
        ...
        self.e_cred_path = ttk.Entry(
            self, width=50, textvariable=self.credentials_string
        )
